        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-8 flex items-center justify-center gap-1 md:gap-2">
            ...
            {[1, 2, 3].map((page) => (
                <button
                    ...
                    className={`w-8 h-8 md:w-10 md:h-10 rounded-full text-xs md:text-sm font-medium transition-colors cursor-pointer border border-gray-300 ${currentPage === page ? "!border-[#ffc765] bg-[#ffc765] text-black" : "text-gray-700 hover:bg-gray-50"
                        }`}
                >
                    {page}
                </button>
            ...
            <button
                ...
                className={`w-8 h-8 md:w-10 md:h-10 rounded-full text-xs md:text-sm font-medium transition-colors cursor-pointer border border-gray-300 ${currentPage === totalPages
                        ? "!border-[#ffc765] bg-[#ffc765] text-black"
