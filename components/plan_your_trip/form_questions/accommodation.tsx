...
const COMMON_ACCOMMODATION_OPTIONS = [
    {
        text: "Luxury 5-Star & Iconic Properties",
        value: "Luxury 5-Star & Iconic Properties",
    },
    {
        text: " Boutique 4-Star & Character-rich stays",
        value: " Boutique 4-Star & Character-rich stays",
    },
    {
        text: "Private Villas & Exclusive Use Estates",
        value: "Private Villas & Exclusive Use Estates",
    },
    {
        text: "I will manage my own accommodations",
        value: "I will manage my own accommodations",
    },
];
...
export default function StepAccommodation({
    ...
    return (
        <div className="space-y-3 md:space-y-5">
            <QuestionHeading title="What level of sanctuary do you prefer?" />
