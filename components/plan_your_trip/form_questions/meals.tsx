...
export default function StepMeals({
    ...
    // Define meals
    const meals = [
        "The Gastronomic Pursuit (Pre-booked Michelin & Fine Dining)",
        "The Authentic Trail (Local Gems, Markets, & Farm-to-Table)",
        "The Balanced Mix (A blend of planned and spontaneous)",
        "Self-Managed (I prefer to find my own meals)",
    ];
    ...
    useEffect(() => {
        if (Array.isArray(planYourTripForm?.meals)) {
            setSelected(planYourTripForm.meals);
        }
    }, [planYourTripForm?.meals]);
    ...
    return (
        <div className="space-y-3 md:space-y-5">
            <QuestionHeading
                ...
                subtitle="How would you like to handle your culinary arrangements?"
            />
