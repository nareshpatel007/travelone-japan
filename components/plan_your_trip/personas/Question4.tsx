...
export default function Question4({
    ...
    useEffect(() => {
        if (planYourTripForm?.question_4) {
            setSelected(planYourTripForm.question_4);
        }
    }, [planYourTripForm?.question_4]);
    ...
    return (
        <div className="space-y-3 md:space-y-5">
            <QuestionHeading
                title="How do you prefer to move between locations?"
            />
            <div className="max-h-[55vh] md:max-h-[60vh] overflow-y-auto space-y-2 md:space-y-3">
                <Option
                    text="A private chauffeured vehicle where I can work or rest in transit."
                    value="Option A"
                    selected={selected}
                ...
                <Option
                    text='A high-speed, first-class rail journey to see the landscape change.'
                    value="Option B"
                    selected={selected}
                    onChange={handleChange}
                />
                ...
                <Option
                    text="I prefer to walk or use local transport to truly feel the city’s pulse."
                    value="Option C"
                    selected={selected}
                    onChange={handleChange}
                />
