            ...
            <div className="border border-black rounded-sm p-5 space-y-3 md:space-y-5 bg-white/60">
                ...
                <div className="flex items-start gap-2 pt-2">
                    ...
                    <label className="text-xs md:text-sm text-black">
                        I agree to the <a href="/legal/terms-service" target="_blank" className="underline">T&Cs</a> and <a href="/legal/privacy-policy" target="_blank" className="underline">Privacy Policy</a>, and consent to receive communications from TravelOne USA, including follow-up call and text messages for quotes, scheduling, and call reminders, regarding my inquiry. Std msg & data rates apply. Text STOP to cancel, HELP for info.
                    </label>
                </div>
            </div>
        </div>
