...
export default function Question5({
    ...
    useEffect(() => {
        if (planYourTripForm?.question_5) {
            setSelected(planYourTripForm.question_5);
        }
    }, [planYourTripForm?.question_5]);
    ...
    return (
        <div className="space-y-3 md:space-y-5">
            <QuestionHeading
                title='What is your relationship with the "outside world" during a journey?'
            />
            <div className="max-h-[55vh] md:max-h-[60vh] overflow-y-auto space-y-2 md:space-y-3">
                <Option
                    text="I need high-speed connectivity; I am always managing my enterprise."
                    value="Option A"
                    selected={selected}
                ...
                <Option
                    text='I check in occasionally, but I prefer to stay in the moment.'
                    value="Option B"
                    selected={selected}
                    onChange={handleChange}
                />
                ...
                <Option
                    text="Complete digital detox. I want to be unreachable and off the grid."
                    value="Option C"
                    selected={selected}
                    onChange={handleChange}
                />
