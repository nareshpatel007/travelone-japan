...
export default function Question8({
    ...
    useEffect(() => {
        if (planYourTripForm?.question_8) {
            setSelected(planYourTripForm.question_8);
        }
    }, [planYourTripForm?.question_8]);
    ...
    return (
        <div className="space-y-3 md:space-y-5">
            <QuestionHeading
                title='How do you feel about "unplanned" moments?'
            />
            <div className="max-h-[55vh] md:max-h-[60vh] overflow-y-auto space-y-2 md:space-y-3">
                <Option
                    text='I want every detail vetted and confirmed by experts before I arrive.'
                    value="Option A"
                    selected={selected}
                ...
                <Option
                    text='I like a framework, but I want my guide to suggest "wildcard" detours.'
                    value="Option B"
                    selected={selected}
                    onChange={handleChange}
                />
                ...
                <Option
                    text="I want to go where no one else goes, regardless of the complexity."
                    value="Option C"
                    selected={selected}
                    onChange={handleChange}
                />
