...
function ThemeItem({
    ...
    return (
        <label
            ...
            className={`flex items-center justify-between gap-3 border px-5 py-3 rounded-sm cursor-pointer transition bg-white ${isActive ? "border-black" : "border-black/30"
                }`}
        >
            <div className="flex flex-center gap-3 text-sm md:text-base text-black">
                {isInPriority1 && (
