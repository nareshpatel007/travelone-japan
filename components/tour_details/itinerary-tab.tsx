...
export function ItineraryTab({ itineraryData, device }: Props) {
    return (
        <div className="py-7">
                    ...
                    {itineraryData.map((dayData: any) => (
                        <div className={`flex ${(device === "mobile") ? '!gap-3' : '!gap-6'}`}>
                            <div className="!flex-shrink-0 !relative">
                                <div className="w-10 h-10 rounded-full bg-[#1E1E1E] text-white flex items-center justify-center font-bold text-md">
                                    {dayData.day}
                                </div>
                            </div>
                            <div className="!flex-1 !bg-white !border-2 !border-[#1E1E1E] !rounded-lg !p-6 !mb-4">
                                ...
                                {dayData.meals && (
                                    <div className="!border-t !border-gray-200 !pt-4 !mb-4">
                                        <span className="!text-[#C46A3A] !font-bold !mb-2">Meals:</span>
