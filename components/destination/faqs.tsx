...
export default function FAQsSection({ pageData }: Props) {
    ...
    return (
        <section className="max-w-7xl mx-auto px-5 md:px-0 md:p-6 py-0 md:py-14 space-y-8">
            <div className="space-y-8">
                <h3 className="text-center text-black text-3xl md:text-5xl leading-tight font-normal">
                    People Also Ask
                </h3>
