            ...
            <div className="max-w-7xl mx-auto px-5 md:px-0 py-6">
                ...
                <div className="flex items-center justify-center px-5 md:px-0 py-12 space-y-12">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-600">✓ We hand-pick your Elite Local Guides.</p>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-600">On this call, we will:</p>
                        ...
                        <p className="text-gray-600">3. Discuss the "Signature Touches" that will make your trip unique.</p>
                    </div>
