import SingleTourPage from "@/components/pages/single-tour";
...
export async function generateMetadata(
    ...
    try {
        ...
        return {
            ...
            alternates: {
                canonical: `${process.env.SITE_URL}/tour/${slug}`,
            },
            openGraph: {
                title: tour?.title,
                description: tour?.description,
                url: `${process.env.SITE_URL}/tour/${slug}`,
                type: "website",
            },
        };
    } catch {
